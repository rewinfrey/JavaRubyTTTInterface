module WebGamePresenter
  ...
  class Base
    ...
    def generate_form(index)
      %Q(<form id="#{index}" class="untaken_square" accept-charset="UTF-8" action="update_game" method="post"><input type="hidden" name="game_id" value="#{id}"><input type="hidden" name="move" value="#{index}"></form>)
    end
